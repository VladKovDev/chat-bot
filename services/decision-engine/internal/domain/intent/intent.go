...
const (
	...
	IntentAskRescheduleRules   Intent = "ask_reschedule_rules"   // Правила переноса
	...
	IntentAskRefundRules       Intent = "ask_refund_rules"       // Правила возврата
	...
	IntentAskAccountStatus     Intent = "ask_account_status"     // Статус аккаунта
...
const (
	...
	IntentComplaintMaster      Intent = "complaint_master"      // Жалоба на мастера
	IntentComplaintPremises    Intent = "complaint_premises"    // Жалоба на помещение
)
...
func All() []string {
	return []string{
		...
		string(IntentAskRescheduleRules),
		...
		string(IntentComplaintMaster),
		string(IntentComplaintPremises),
	}
}
