...
func (a *FindWorkspaceBooking) Execute(ctx context.Context, data action.ActionData) error {
	...
	// Generate mock data
	mockData := a.generateMockWorkspaceBooking(identifier, data.Session.ChatID)
...
func (a *FindWorkspaceBooking) generateMockWorkspaceBooking(input string, chatID int64) map[string]interface{} {
